  ...
  if (vClassName != "") {
    if (top.vJSON_JS) {
      if (top.vJSON_JS.ClassList) {
        ...
        console.log("getClassJSON('"+pClassName+"') ClassList undefined");
        initClassJS(pClassName,null,"getClassJSON()");
      };
    } else {
      initClassJS(pClassName,null,"getClassJSON()");
      alert("getClassJSON('"+pClassName+"') vJSON_JS as Main Project DB is undefined");
    };
  };
  if (!vRetClass) {
